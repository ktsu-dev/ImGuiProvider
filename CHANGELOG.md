...
No significant changes detected since v1.1.28.
...
- fix: remove unnecessary unsafe modifiers from HexaNet provider methods ([@matt-edmondson](https://github.com/matt-edmondson))
